...
<asp:Content ID="Content2" ContentPlaceHolderID="pageContentSub" Runat="Server">
    ...
    <p>Provide a log-in and password for the LCCC email account being used to send the emails.</p>
    ...
    <p>
        <label>Log-In:</label><asp:TextBox ID="emailAddressTextBox" runat="server"></asp:TextBox>
        <label>Password:</label><asp:TextBox ID="emailPasswordTextBox" runat="server" TextMode="Password"></asp:TextBox>
    </p>
